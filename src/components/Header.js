        ...
        <div className="flex items-center gap-3">
          <div className="">
            <div className="text-green color-green">
              <Link to="https://wa.me/254707869120">
                <WhatsAppIcon className="text-green-600 " /> or{" "}
                <AddIcCallIcon className="text-blue-600" />
              </Link>
            </div>
            <div className="text-green color-green">
              <Link to="https://wa.me/254707869120" className="text-green-600 ">
                0707869120
              </Link>
            </div>
            <div>
              <Link to="tel:+254707869120" className="text-blue-600">
                {" "}
                0707869120
              </Link>
            </div>
          ...
          <div>
            {user?._id ? (
              <button
                ...
                className="px-3 py-1 rounded-full text-white bg-green-600 hover:bg-red-700"
              >
                Logout
              </button>
            ) : (
